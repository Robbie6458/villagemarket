...
export default function HomePage() {
  ...
  const filtered = useMemo(() => {
    ...
    return results;
  }, [search, category, contributorOnly, deliveryOnly, customOrdersOnly, barterOnly, availableNow, sort]);
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-6">
          ...
          <Toggle label="Custom orders open" active={customOrdersOnly} onChange={setCustomOrdersOnly} />
          <Toggle label="Open to barter" active={barterOnly} onChange={setBarterOnly} />
          <Toggle label="Contributors only" active={contributorOnly} onChange={setContributorOnly} dot="bg-moss" />
          ...
          <div className="ml-auto">
            ...
            >
              ...
              <option value="delivery">Delivery available first</option>
